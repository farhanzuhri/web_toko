<div class="section">
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form enctype="multipart/form-data" action="?page=user/kategori.php" method="POST">
															<input type="hidden" name="category_id" value="<?php echo $row['category_id'] ?>">
															<div class="mb-3">
																<label for="exampleInputPassword1" class="form-label">Kategori</label>
																<input name="kategori" type="text" value="<?php echo $row['category_name'] ?>" class="form-control" id="exampleInputPassword1">
															</div>
	...
	if (isset($_POST['bubah'])) {
		...
		if ($sql) {
			echo "<script>alert('Update berhasil'); window.location.href = '?page=user/kategori.php';</script>";
		} else {
			echo "<script>alert('Update gagal'); window.location.href = '?page=user/kategori.php';</script>";
		}
	}
	?>
    ...
    if (isset($_POST['bhapus'])) {
        ...
        if ($sql) {
            echo "<script>alert('Hapus Data Berhasil'); window.location.href = '?page=user/kategori.php';</script>";
        } else {
            echo "<script>alert('Hapus Data Gagal'); window.location.href = '?page=user/kategori.php';</script>";
        }
    }
    ?>
    ...
    if (isset($_POST['bsimpan'])) {
        ...
        if ($sql) {
            echo "<script>alert('Insert berhasil'); window.location.href = '?page=user/kategori.php';</script>";
        } else {
            echo "<script>alert('Insert gagal'); window.location.href = '?page=user/kategori.php';</script>";
        }
    }
    ?>