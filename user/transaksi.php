            ...
            <div class="box">
                <div class="card mb-4 mt-3">
                    <div class="card-header">
                        <a href="user/insertpembayaran.php"><i class="fa-solid fa-plus" style="font-size: 20px; color: green;"></i></a>
                    </div>
                    <div class="card-body">
                                ...
                                if (mysqli_num_rows($sql) > 0) {
                                    while ($row = mysqli_fetch_array($sql)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="user/cetak.php?transaksi_id=<?php echo $row['transaksi_id'] ?>" target="blank"><i class="fa-solid fa-print" name="cetak" style="font-size: 20px; color: green;">Cetak</i></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form enctype="multipart/form-data" action="?page=user/transaksi.php" method="POST">
