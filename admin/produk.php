  <div class="section">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form enctype="multipart/form-data" action="?page=admin/produk.php" method="POST">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input name="produk" type="text" value="<?php echo $row['product_name'] ?>" class="form-control" id="exampleInputPassword1" required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="exampleInputPassword1" class="form-label">Harga</label>
                                                                    <input name="harga" type="text" value="Rp. <?php echo number_format($row['product_price']) ?>" class="form-control" id="exampleInputPassword1" required>
                                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="?page=admin/produk.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Nama Produk</label>
                            <input name="produk" type="text" class="form-control" id="exampleInputPassword1" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Harga</label>
                            <input name="harga" type="text" class="form-control" id="exampleInputPassword1" required>
                        </div>
                        <div class="modal-footer">
    ...
    if (isset($_POST['bhapus'])) {
        ...
        if ($sql) {
            echo "<script>alert('Hapus Data Berhasil'); window.location.href = '?page=admin/produk.php';</script>";
        } else {
            echo "<script>alert('Hapus Data Gagal'); window.location.href = '?page=admin/produk.php';</script>";
        }
    }
    ?>
    ...
    if (isset($_POST['bsimpan'])) {
        ...
        if ($sql) {
            echo "<script>alert('Insert berhasil'); window.location.href = '?page=admin/produk.php';</script>";
        } else {
            echo "<script>alert('Insert gagal'); window.location.href = '?page=admin/produk.php';</script>";
        }
    }
    ?>
